...
func (q *Queries) CreateAccount(ctx context.Context, arg CreateAccountParams) (Account, error) {
	row := q.queryRow(ctx, q.createAccountStmt, createAccount, arg.Name, arg.Balance, arg.Currency)
	var i Account
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) DeleteAllAccount(ctx context.Context) error {
	_, err := q.exec(ctx, q.deleteAllAccountStmt, deleteAllAccount)
	return err
}
...
func (q *Queries) GetListAccount(ctx context.Context, arg GetListAccountParams) ([]Account, error) {
	rows, err := q.query(ctx, q.getListAccountStmt, getListAccount, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
