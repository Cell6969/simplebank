...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.deleteAllAccountStmt, err = db.PrepareContext(ctx, deleteAllAccount); err != nil {
		return nil, fmt.Errorf("error preparing query DeleteAllAccount: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.deleteAllAccountStmt != nil {
		if cerr := q.deleteAllAccountStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing deleteAllAccountStmt: %w", cerr)
		}
	}
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		deleteAllAccountStmt: q.deleteAllAccountStmt,
